export const CONTRACT_ADDRESS =
  "ZyUfp3tPg9NLr1v4FrMgvrQDosebaJURSpCPyDWBmLwoUhH";
    ...
    spec: {
      ...
      messages: [
        ...
        },
        {
          ...
          payable: false,
          returnType: {
            displayName: ["psp34burnable_external", "BurnOutput"],
            type: 30,
          },
          selector: "0x63c9877a",
        },
                ...
                fields: [
                        ...
                        fields: [
                          ...
                          },
                          {
                            layout: {
                              enum: {
                                dispatchKey:
                                  "0xb7a71e4002c7879d26cf12fa4e7974c49d0726c7f0a89c808ab143546ccf0a4c",
                                variants: {
                                  0: {
                                    fields: [
                                      {
                  ...
                  },
                  {
                    layout: {
                      enum: {
                        dispatchKey:
                          "0xbc1ad52bdf66c4b31efe8d66cea66b6f6365ce24823669066601b29c4e05a571",
                        variants: {
                          0: {
                            fields: [
                              {
                ...
                fields: [
                  ...
                  },
                  {
                    layout: {
                      enum: {
                        dispatchKey:
                          "0x68b8d3659b5eb4a0b97187fafa7fa9323b33c1b0d9f17dc78b89f4319216d42d",
                        variants: {
                          0: {
                            fields: [
                              {
